...
# from ..app import HistoricalValidationToolSomalia
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_somalia"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_somalia.tests.tests"

        To run tests in the HistoricalValidationToolSomaliaTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_somalia.tests.tests.HistoricalValidationToolSomaliaTestCase"

        To run only the test_if_tethys_platform_is_great function in the HistoricalValidationToolSomaliaTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_somalia.tests.tests.HistoricalValidationToolSomaliaTestCase.test_if_tethys_platform_is_great"
...
class HistoricalValidationToolSomaliaTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(HistoricalValidationToolSomalia)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(HistoricalValidationToolSomalia)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/historical-validation-tool-somalia/')  # The final '/' is essential for all pages/controllers
