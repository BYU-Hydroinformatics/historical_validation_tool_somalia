...
def get_scatterPlot(request):
    ...
    try:
        ...
        layout = go.Layout(title="Scatter Plot for River {0} at {1}".format(nomRiver, nomEstacion),
...
def get_volumeAnalysis(request):
    ...
    try:
        ...
        layout = go.Layout(
            title='Observed & Simulated Volume for River {0} at {1}'.format(nomRiver, nomEstacion),
...
def get_observed_discharge_csv(request):
    ...
    try:
        ...
        response['Content-Disposition'] = 'attachment; filename=observed_discharge_{0}_at_{1}.csv'.format(nomRiver, nomEstacion)
...
def get_simulated_discharge_csv(request):
    ...
    try:
        ...
        response = HttpResponse(content_type='text/csv')
        response['Content-Disposition'] = 'attachment; filename=simulated_discharge_{0}_at_{1}.csv'.format(nomRiver, nomEstacion)
